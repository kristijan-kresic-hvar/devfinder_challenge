  ...
  return (
    <div className="devCard">
      ...
      <div className="devCard__content">
        <div className="devCard__content__heading">
          <div className="devCard__content__heading__name">
            <h2>{data.name}</h2>
            <small>@{data.login}</small>
          </div>
          <div className="devCard__content__heading__date">
            <p>
              Joined{" "}
        ...
        <div className="devCard__content__following">
          ...
          <div className="devCard__content__following__followers">
            <h4>Followers</h4>
            <p>{data.followers}</p>
          </div>
          <div className="devCard__content__following__following">
            <h4>Following</h4>
            <p>{data.following}</p>
          </div>
        </div>
        <div className="devCard__content__footer">
          <div style={dimNoContent(data.location)}>
          ...
          <div style={dimNoContent(data.twitter_username)}>
          ...
          <div style={dimNoContent(data.blog)}>
          ...
          <div style={dimNoContent(data.company)}>
            <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              <g fill="#4b6a9b">
